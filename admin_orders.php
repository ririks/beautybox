...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      if(mysqli_num_rows($select_orders) > 0){
         while($fetch_orders = mysqli_fetch_assoc($select_orders)){
            $proof = $fetch_orders['proof'];
            $imagePath = "proof/$proof";
            $imageURL = file_exists($imagePath) ? $imagePath : "placeholder.jpg";
      ...
      <div class="box">
         ...
         <p> proof of payment :
            <span>
               <button type="button" onclick="showPaymentProof('<?php echo $imageURL; ?>')">View Payment</button>
            </span>
         </p>
   ...
   <script>
      function showPaymentProof(imageURL) {
         var popup = window.open(imageURL, "_blank", "width=600, height=600");
         popup.focus();
      }
   </script>
